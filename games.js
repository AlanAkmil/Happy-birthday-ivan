/* ============================================================
   games.js — 3 mini game: Kuis Receh, Cari Pasangan, Tangkap Bintang
   ============================================================ */
...
(function () {
  ...
  const GAMES = [
    { id: "quiz", icon: "🎉", title: "Kuis Receh", desc: "seberapa kenal lo sama gua?" },
    { id: "memory", icon: "🧠", title: "Cari Pasangan", desc: "cocokin kartunya" },
    { id: "catch", icon: "⭐", title: "Tangkap Bintang", desc: "tangkap sebanyak mungkin" },
  ];
  ...
  function renderQuiz() {
    ...
    function showResult() {
      stage.innerHTML = `
        ...
        <p class="game-sub">makasih udah main ya, Van</p>
  ...
  function renderCatch() {
    ...
    stage.innerHTML = `
      <h3 class="game-title">Tangkap Bintang</h3>
      <p class="game-sub">tap bintang yang jatuh sebelum nyentuh dasar</p>
    ...
    window.__catchInterval = setInterval(() => {
      ...
      if (timeLeft <= 0) {
        ...
        stage.innerHTML = `
          ...
          <p class="quiz-result">Skor lo: ${score} ⭐</p>
